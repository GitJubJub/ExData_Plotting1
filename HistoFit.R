...
dev.off()
## Step 4. Create the Second Plot - Graphing Global Power by Weekday
...
dev.off()
## Step 5. Graphing Energy of Submetering
...
## Step 6. Graphing Fourplots of GAP, Voltage, Submetering, Global Reactive Power
